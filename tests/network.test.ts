...
describe('Rialo network registry', () => {
  test('uses the verified DevNet deployment registry', () => {
    ...
    expect(config.scheduledTransfer.programId).toBe(deployment.programs.scheduledTransferV2SurplusP0Test.programId);
    expect(config.scheduledTransfer.artifactSha256).toBe(deployment.programs.scheduledTransferV2SurplusP0Test.artifactSha256);
